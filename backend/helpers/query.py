...
with open('4300-Final-Project-2023/' + 'wiki_tf_idf.pkl', 'rb') as pickle_file:
    wiki_tfidf = pickle.load(pickle_file)

# unpickle song_tf_idf (X)
with open('4300-Final-Project-2023/' + 'song_tf_idf.pkl', 'rb') as pickle_file:
    song_tfidf = pickle.load(pickle_file).toarray()

# unpickle loc_to_index
with open('4300-Final-Project-2023/' + 'loc_to_index.pkl', 'rb') as pickle_file:
    loc_to_idx = pickle.load(pickle_file)

# unpickle song_to_index
with open('4300-Final-Project-2023/' 'song_to_index.pkl', 'rb') as pickle_file:
    song_to_idx = pickle.load(pickle_file)

# unpickle index_to_song
with open('4300-Final-Project-2023/' + 'index_to_song.pkl', 'rb') as pickle_file:
    idx_to_song = pickle.load(pickle_file)

with zipfile.ZipFile('4300-Final-Project-2023/' + 'dataset/big_df_edited.csv.zip', 'r') as zip_ref:
    zip_ref.extractall('4300-Final-Project-2023/' + 'dataset/')
