...
my_stop_words = text.ENGLISH_STOP_WORDS.union(
    {'city', 'like', 'zwischen', 'just', 'let'}.union(set(more_stop_words)))
...
X = vectorizer.fit_transform(
    big_df['tknzd_lyrics'].apply(lambda x: " ".join(x)))

with open('vectorizer.pkl', 'wb') as f:
    pickle.dump(vectorizer, f)

index_to_word = {i: v for i, v in enumerate(
    vectorizer.get_feature_names_out())}
word_to_index = {v: i for i, v in enumerate(
    vectorizer.get_feature_names_out())}
